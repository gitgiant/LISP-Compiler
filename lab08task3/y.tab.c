...
#line 1224 "y.tab.c" /* yacc.c:1646  */
  ...
  case 3:
#line 43 "l8t3.y" /* yacc.c:1646  */
    {
                              // printf("yacc: program expr\n"); 
                              translate((yyvsp[-1].astNode));
